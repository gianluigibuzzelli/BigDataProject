...
SPARK_SCRIPT_PATH="/home/${SSH_USER}/pog/cluster/Spark_sql_AVG_cluster.py"

# Directory dove i log e i tempi verranno temporaneamente salvati sul nodo master EMR
LOCAL_LOG_DIR_ON_EMR="/home/${SSH_USER}/spark_logs_sql_make_model/"
LOCAL_LOG_FILE_ON_EMR="${LOCAL_LOG_DIR_ON_EMR}spark_sql_results.txt"
LOCAL_TIMES_FILE_ON_EMR="${LOCAL_LOG_DIR_ON_EMR}spark_sql_exec_times.txt"

# Directory locale dove scaricherai i risultati e genererai il grafico
LOCAL_RESULTS_DIR="/media/gianluigi/Z Slim/Risultati_cluster_/"
LOCAL_GRAPH_FILE_PATH="${LOCAL_RESULTS_DIR}spark_sql_exec_times.png"
LOCAL_TIMES_FILE_PATH="${LOCAL_RESULTS_DIR}spark_sql_exec_times.txt"

# Assicurati che la directory locale per i risultati esista
mkdir -p "${LOCAL_RESULTS_DIR}"

echo "Starting Spark SQL Make/Model Analysis job on EMR cluster..."
...
plt.title('Spark SQL Make/Model Analysis: Time vs Dataset Size (EMR Cluster)', fontsize=14)
